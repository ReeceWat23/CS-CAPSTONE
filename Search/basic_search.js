...
export const search_referrals = async (req, res) => {
    try {
        ...
        // const referrals = referralsData.response?.referrals || referralsData.referrals || referralsData || [];
        ...
        const matches = referrals
            .map(referral => {
                ...
                // Boost score based on agent_score (quality indicator)
                score += (referral.agent_score || 0) * 0.5;

                // Boost score based on requests (popularity indicator)
